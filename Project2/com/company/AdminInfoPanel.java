...
class AdminInfoPanel extends JPanel{
    ...
    String filePath="Admin Personal Info.txt"; //in the same directory

    public AdminInfoPanel() {
        //construct components
        admininfolabel = new JLabel ("Admin Personal Information");
        fullnamelabel = new JLabel ("Admin Fullname       :");
        ...
        admininfolabel.setBounds (250, 15, 215, 40);
    ...
    public static void main (String[] args) {
        JFrame frame = new JFrame ("Admin Personal Information");
        frame.setDefaultCloseOperation (JFrame.EXIT_ON_CLOSE);
        frame.getContentPane().add (new AdminInfoPanel());
        frame.pack();
